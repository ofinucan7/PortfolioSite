...
const ProjRightCol = () => {
  const imgs = portfolio_site.imgs;
  ...
  return (
    <div className="relative z-10 p-6 mt-[16px] w-full text-left text-[#F1EFEC]">
      ...
      <div className="bg-[#123458] p-4 mb-[16px] rounded-lg shadow text-[#F1EFEC] z-50">
        <h1 className="text-xl font-semibold mb-2"> About the Project </h1>
        <p className="text-sm leading-relaxed z-50"> { dialogue } </p>
      </div>
    </div>
  );
};
